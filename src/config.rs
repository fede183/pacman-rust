...
pub const PACMAN_SIZE: f32 = SQUARE_SIZE / 2.;
pub const WALL_THICKNESS: f32 = 3.;

pub const WALL_LEFT_POSITION: Vec3 = Vec3::new(-LIMIT_WIGTH / 2., LIMIT_POSITIONS.y, LIMIT_POSITIONS.z);
pub const WALL_RIGHT_POSITION: Vec3 = Vec3::new(LIMIT_WIGTH / 2., LIMIT_POSITIONS.y, LIMIT_POSITIONS.z);
pub const WALL_UP_POSITION: Vec3 = Vec3::new(LIMIT_POSITIONS.x, SQUARE_SIZE * 3.5, LIMIT_POSITIONS.z);
pub const WALL_DOWN_POSITION: Vec3 = Vec3::new(LIMIT_POSITIONS.x, -SQUARE_SIZE * 5.5, LIMIT_POSITIONS.z);
